import { wireAutoListen }  from './audio/recorder.js';
import { playBase64Audio } from './audio/player.js';
import { state as globalState } from './core/state.js';  // optional, if you need ctx later
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    wireAutoListen(
          autoListenBtn,   // DOM node
          processAudio,    // callback we already have below
          updateStatus     // your UI helper
        );
        ...
        try {
            ...
            if (data.status === 'success') {
                ...
                if (data.assistant_response_audio) {
                    ...
                    playBase64Audio(data.assistant_response_audio);
